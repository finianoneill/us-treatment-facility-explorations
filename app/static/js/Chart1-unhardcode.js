...
.then(data => {
    ...
    data.forEach((row) => {
      ...
      Object.entries(row).forEach(([key,value]) => {
        ...
        else if (key==="Number_of_facilities"){
          numOfFacilities.push(Number(value));
        }
        else if (key==="Total_Population"){
          totalPop.push(Number(value));
        }
        else if (key==="Median_Age"){
          medianAge.push(Number(value));
        }
        else if (key==="Average_Income"){
          avgHouseholdIncome.push(Number(value));
        }
        else if (key==="Poverty_Count"){
          povertyCount.push(Number(value));
        }
        else if (key==="Per_Capita_Income") {
          perCapitaIncome.push(Number(value));
        }
        }) 
    })   
  });
